namespace ShieldManager.ViewOfDevicesOfShield
{
    ...
    public class ParametersOfShield
    {
        ...
        private Dictionary<string, Parameter> _cl2Parameter = new Dictionary<string, Parameter>();
        private Dictionary<string, Parameter> _nm1Parameter = new Dictionary<string, Parameter>();
        private Dictionary<string, Parameter> _nm2Parameter = new Dictionary<string, Parameter>();
