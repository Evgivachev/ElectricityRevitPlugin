...
public class ModelUpdater
{
    ...
    private SaveAsOptions _saveAsOption = new()
    {
        Compact = false,
        MaximumBackups = 1,
    ...
    private WorksetConfiguration _worksetConfiguration = new(WorksetConfigurationOption.CloseAllWorksets);

    private WorksharingSaveAsOptions _worksharingSaveAsOptions = new()
    {
