...
{
    private readonly Guid _isProhibitChangesGuid = new("5de14719-6968-4655-9457-94825e70b623");
    ...
    protected override Guid UpdaterGuid { get; } = new("FEDA2F29-FFFF-4478-A095-450CF8A51AE1");
